; mod by wilk (tryby mieszania 1: wszystko razem, 2: po wyrazach; !podp i ponowne mieszanie, ochrona przed niepomieszanym wyrazem, wyswietlanie czasu odpowiedzi, poprawki kodu i inne)
...
alias autom {
  set %delay 7
  unset %mkkanal %wyraz %pomieszany_wyraz %score* %wyniki* %poz* %xx %xxx %punkty* %qqstart
